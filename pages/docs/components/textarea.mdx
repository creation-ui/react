...
>
  <TextAreaPlayground label='TextArea' />
</Playground>

It's important to note that the TextArea component's width won't 'adjusts dynamically like [Input](/docs/components/input) because it has `resize` class and can be manually resized by dragging the bottom-right corner.
