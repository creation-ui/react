...
function loader(context, source) {
  return __async(this, null, function* () {
    ...
    if (theme.startsWith(".") || theme.startsWith("/")) {
      context.addDependency(path4.resolve(theme));
    }
    if (themeConfig) {
      context.addDependency(path4.resolve(themeConfig));
    }
    ...
    const { result, headings, structurizedData, hasJsxInH1, readingTime } = yield compileMdx(
      content,
      {
        mdxOptions: __spreadProps(__spreadValues(__spreadValues({}, mdxOptions), frontMatter.mdxOptions), {
          jsx: true,
...
export default MDXContent`;
    ...
    if (transform) {
      finalResult = yield transform(finalResult, {
        route: pageNextRoute
      });
    }
