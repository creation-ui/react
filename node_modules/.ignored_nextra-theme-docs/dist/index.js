...
var theme;
var isValidated = process.env.NODE_ENV === "production";
var ConfigProvider = ({
  children,
...
function FolderImpl({
  ...
  const open = TreeState[item.route] !== void 0 ? TreeState[item.route] || focusedRouteInside : active || activeRouteInside || focusedRouteInside || (theme2 && "collapsed" in theme2 ? !theme2.collapsed : folderLevel <= config.sidebar.defaultMenuCollapseLevel);
...
function isReactNode(value) {
  return isString(value) || isValidElement(value) || isFunction(value);
}
...
var Pre = (_a) => {
  ...
  return /* @__PURE__ */ React43.createElement(React43.Fragment, null, filename && /* @__PURE__ */ React43.createElement("div", {
    ...
    getValue: () => {
      var _a2, _b2;
      return ((_b2 = (_a2 = preRef.current) == null ? void 0 : _a2.querySelector("code")) == null ? void 0 : _b2.textContent) || "";
    }
  })));
};
...
var InnerLayout = ({
  ...
  }, children)))), renderComponent(config.footer.component, { menu: hideSidebar }));
};
function Layout(_a) {
  var _b = _a, {
    children
  ...
  return /* @__PURE__ */ React45.createElement(ConfigProvider, {
    value: context
  }, /* @__PURE__ */ React45.createElement(InnerLayout, __spreadValues({}, context.pageOpts), children));
}
export {
  Bleed,
  Callout,
