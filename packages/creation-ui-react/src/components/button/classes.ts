...
import { sharedDisabledObject, sharedSizeClassesObject } from '../../classes'
...
export const button = cva(
  ...
  ],
  {
    variants: {
      ...
      size: {
        sm: [...sharedSizeClassesObject.sm, 'px-4'],
        md: [...sharedSizeClassesObject.md, 'px-5'],
        lg: [...sharedSizeClassesObject.lg, 'px-6'],
      },
      variant: {
        contained: null,
        outlined: null,
